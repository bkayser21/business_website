...
function CalendlyEmbed() {
  ...
  return (
    <div
      className="calendly-inline-widget w-full rounded-xl overflow-hidden border border-lavender"
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex flex-col gap-4 text-sm text-stone">
              <div className="flex items-center gap-3">
                <svg className="w-4 h-4 text-cyan-deep flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
